...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">Controle de livros<img src="./img/iconlivro.png" id="imgIcon" /> - (PRETENÇÕES!)</a>
        </nav>
    </div><br>
                    ...
                    <tbody>
                        <?php
                            ...
                            if(isset($_POST['busca'])){
                                $busca = $_POST['busca'];
                                $sql = "SELECT * FROM `livros` WHERE `status` = 'pretencao' AND nome LIKE '%".$busca."%';";    
                            } else {
                                $sql = "SELECT * FROM `livros` WHERE `status` = 'pretencao';";                            
                            }
